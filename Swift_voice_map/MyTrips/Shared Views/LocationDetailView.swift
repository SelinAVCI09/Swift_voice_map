    ...
    var body: some View {
        VStack {
            ...
            if let lookaroundScene {
                ...
                ContentUnavailableView("Ön gösterim bulunamadı", systemImage: "eye.slash")
            }
            HStack {
                Spacer()
                if let destination {
                    ...
                    Button {
                        ...
                        Label(inList ? "Sil" : "Add", systemImage: inList ? "minus.circle" : "plus.circle")
                    }
                    .buttonStyle(.borderedProminent)
                    ...
                    HStack {
                        Button("Maps'te Aç", systemImage: "map") {
                            if let selectedPlacemark {
